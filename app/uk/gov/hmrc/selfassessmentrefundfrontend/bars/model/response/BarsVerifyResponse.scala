...
import uk.gov.hmrc.selfassessmentrefundfrontend.bars.model.response.BarsAssessmentType.Yes
...
object BarsVerifyResponse {
  ...
  object NonStandardAccountDetailsRequired {
    def unapply(response: BarsVerifyResponse): Boolean = response.nonStandardAccountDetailsRequiredForBacs === Yes
  }
}
