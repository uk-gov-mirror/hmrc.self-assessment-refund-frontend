...
package uk.gov.hmrc.selfassessmentrefundfrontend.bars.model.response
...
final case class SortCodeDoesNotSupportDirectCreditValidateResponse(barsResponse: ValidateResponse) extends BarsValidateError
...
final case class SortCodeDoesNotSupportDirectCredit(barsResponse: BarsResponse) extends BarsVerifyError
...
final case class NonStandardDetailsRequired(barsResponse: BarsResponse) extends BarsVerifyError
