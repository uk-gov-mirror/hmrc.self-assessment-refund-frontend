...
class AppConfig @Inject() (config: Configuration, servicesConfig: ServicesConfig) {
  ...
  val upliftOrigin: String = servicesConfig.getConfString("iv-uplift.origin", throwConfigNotFoundError("iv-uplift.origin"))
  val confidenceLevel: String = servicesConfig.getConfString("iv-uplift.confidenceLevel", throwConfigNotFoundError("iv-uplift.confidenceLevel"))
  ...
  val refundIssuedIndividualOrOrganisationUrl: String = itsaUrl + servicesConfig.getString("navigation.paths.refundIssuedIndividualOrOrganisation")
  val viewAndChangeHubIndividualOrOrganisationUrl: String = itsaUrl + servicesConfig.getString("navigation.paths.viewAndChangeHubIndividualOrOrganisation")
