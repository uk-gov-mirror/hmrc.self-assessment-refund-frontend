...
final case class Amount(
  ...
  def repay: BigDecimal = repayment.getOrElse(
    totalCreditAvailableForRepayment.getOrElse(
      throw new Throwable("totalCreditAvailableForRepayment not found for journey")
    )
  )
