...
class WeCannotConfirmYourIdentityControllerSpec extends ItSpec with WeCannotConfirmYourIdentityPageTesting {
  ...
  "a failedUplift" should {
    "display WeCannotConfirmYourIdentity page in refund request journey" in {
      val upLift: WeCannotConfirmYourIdentityControllerRefundRequest = fakeApplication().injector.instanceOf[WeCannotConfirmYourIdentityControllerRefundRequest]
      ...
      AuditStub.verifyEventAudited("IdentityVerificationOutcome", Json.parse("""{"isSuccessful":false,"userType":"Individual"}""").as[JsObject])
    }
    ...
    "display WeCannotConfirmYourIdentity page in refund tracker journey" in {
      val upLift: WeCannotConfirmYourIdentityControllerRefundTracker = fakeApplication().injector.instanceOf[WeCannotConfirmYourIdentityControllerRefundTracker]
